...
//                 <Card className="box w-full 1g:w-1/4 flex flex-col items-center rounded-md p-5"> 
//                     <TaskAltIcon sx={{fontSize: "5rem", color: green [500]}}/> 
//                     <h1 className="py-5 text-2x1 font-semibold">Order Success</h1> 
...
export const PaymentSuccess = () => {
    const navigate = useNavigate();
    const { id } = useParams(); // Optional: capture order ID
